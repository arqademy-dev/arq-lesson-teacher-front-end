    ...
    <div className="relative min-h-screen">
      ...
      >
            ...
            {NAV.map((item) => {
              ...
              if (locked) {
                return (
                  <div
                    key={item.href}
                    className="flex items-center gap-2.5 w-full px-2.5 py-2 rounded-[8px] text-[13px] font-semibold opacity-40 cursor-not-allowed mb-0.5"
                    style={{ color: "var(--rail-ink)" }}
                  >
        ...
        <div className="flex flex-col min-w-0">
          ...
          <div className="px-6 pt-6 pb-14 max-w-[1100px] w-full mx-auto">
            {(title || subtitle) && (
              <div className="mb-5">
                {subtitle && (
