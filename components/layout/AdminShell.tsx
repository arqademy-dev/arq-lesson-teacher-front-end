...
export function AdminShell({
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        className="relative z-[1] grid min-h-screen"
        style={{ gridTemplateColumns: "var(--rail-w, 236px) 1fr" }}
      >
        {/* -------- Rail -------- */}
        <aside
          ...
          style={{
            background: "var(--rail)",
            borderColor: "var(--rail-line)",
          }}
        >
          <div
            className="flex items-center gap-2.5 px-[18px] py-5 border-b"
          ...
          <nav className="flex-1 overflow-y-auto px-2.5 py-3.5">
            <p
              className="text-[9px] font-bold tracking-[0.18em] uppercase px-2.5 pt-1 pb-2"
            ...
            {NAV.map((item) => {
              ...
              const showBadge =
                item.href === "/admin/educators" && pendingCount > 0;
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={cn(
                    "relative flex items-center gap-2.5 w-full px-2.5 py-2 rounded-[8px] text-[13px] font-semibold transition-colors mb-0.5",
                ...
                >
                  ...
                  {showBadge && (
                    <span className="ml-auto text-[10.5px] font-bold px-1.5 py-0.5 rounded-full bg-[rgba(228,86,76,.20)] text-[#FF9A92]">
                      {pendingCount}
                    </span>
                  )}
                </Link>
          ...
          <div
            className="px-[18px] pt-3 pb-3 border-t mt-1"
            style={{ borderColor: "var(--rail-line)" }}
          >
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[11.5px] font-bold text-[#D6DEEE] truncate">
                  {userName}
                </div>
                <div
                  className="text-[9.5px] font-semibold tracking-[0.09em] uppercase"
        ...
        <div className="flex flex-col min-w-0">
          <header
            className="sticky top-0 z-40 flex items-center gap-3.5 px-6 border-b"
            style={{
          ...
          >
            <div className="flex items-center gap-1.5 text-[12.5px] min-w-0">
              ...
              <ChevronRight className="w-3.5 h-3.5 opacity-40" style={{ color: "var(--ink-3)" }} />
          ...
          <div className="px-6 pt-6 pb-14 max-w-[1420px] w-full mx-auto">
            {(title || subtitle) && (
              <div className="mb-5">
                {subtitle && (
                ...
                {title && (
                  <h1 className="font-heading text-[22px] text-[var(--ink)] leading-tight">
                    {title}
                  </h1>
                )}
              </div>
